...
### A. Active Plan Switchboard Decoupling (`aapp active`)
...
- [ ] Task 4.2: Update `ARCHITECTURE.md` and `.agents/CODEMAP.md` with `active` and `plan` contracts.
...
- [ ] `README.md` -> Documentation alignment for `aapp active` and `/plan`.
