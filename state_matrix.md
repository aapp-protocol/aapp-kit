...
- 🟣 **P-22**: [`P22-config-backed-plan-id-allocation.md`](current/P22-config-backed-plan-id-allocation.md) — Config-Backed Monotonic Plan ID Allocation (`aapp.lastPlanId`) — retires the three-tier ID scan. Promoted from `#69`.
