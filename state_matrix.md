...
- 🟣 **P-21**: [`P21-project-pause-and-circuit-breaker.md`](current/P21-project-pause-and-circuit-breaker.md) — Project Pause & Circuit Breaker Architecture (`aapp pause`, `aapp resume`).
