...
- 🔴 **P-14**: [`P14-ai-attribution-suite.md`](current/P14-ai-attribution-suite.md) — AI Attribution Suite (`aapp ai-commit`, `aapp ai-notes`, `aapp ai-off`), Safe-by-Default Protocol & Historical Scrubber (#66).
