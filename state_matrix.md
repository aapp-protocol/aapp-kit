...
- 🟡 **P-20**: [`P20-canonical-plan-command-and-context-decoupling.md`](current/P20-canonical-plan-command-and-context-decoupling.md) — Canonical Blueprint Planning & Active Plan Buffer Decoupling (`/plan`, `aapp active`).
