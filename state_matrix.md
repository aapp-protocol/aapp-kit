...
- 🟢 [`plan-feature-aapp-flat-issues-and-archival.md`](current/plan-feature-aapp-flat-issues-and-archival.md) — Flat Issue Ledger, Universal Domain Taxonomy (`UI`, `DB`, `NET`, `SEC`, etc.), and Master Issue Archival Protocol.
