...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 2026-09-15 | `P-9` | [`P9-guard-path-authorization.md`](P9-guard-path-authorization.md) | `#65` (also closes `#53`, `#54`) | `acd15a4` | External path allowlist (Claude, Antigravity, Codex, Cursor, XDG, tmp), Section 2b hard-deny, lexical canonicalization, and `MultiEdit` matcher coverage. |
