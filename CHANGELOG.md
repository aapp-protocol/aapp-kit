...
### Added
- Security, Threat Model & Trust Boundaries Documentation (`README.md`, `MANUAL.md`): Formulates AAPP's threat model, pair-programming trust assumptions, cognitive drift prevention vs. adversarial malice, 4-layer defense-in-depth hierarchy (Layers 0–3), and rationale for why process containment is governed at the host/container level rather than git hooks.
