...
| #57 | `Medium` | `SEC` | 2026-09-10 | `templates/blast-radius-guard.sh:203` | File marked Out of Bounds by one plan is allowed when second active plan lists it as target. | [P-17](current/P17-blast-radius-precision-and-isolation.md) *(Superseded)* | 🔵 `Planned` |
